...
export const LIVE_ASSETS: AssetCatalogItem[] = [
  ...
  createAsset("SOL", "Solana", "crypto", "high throughput crypto", "USD", "SOL-USD"),
  createAsset("XRP", "XRP", "crypto", "payments-focused crypto", "USD", "XRP-USD"),
...
const DATA_CATALOG: Record<MarketDataTicker, ProviderDescriptor> = {
  ...
  SOL: createDescriptor("SOL", "Solana", "USD", "close", "SOL-USD"),
  XRP: createDescriptor("XRP", "XRP", "USD", "close", "XRP-USD"),
