...
export async function generateMetadata({
  ...
  const title = hasResultPreview
    ...
    : "RegretZero | 그때 샀다면 지금 어디쯤일까요?";
  const description = hasResultPreview
    ? `${asset ?? "선택 자산"}의 10년 결과를 요약 카드로 확인하세요. 최종 금액과 버텨야 했던 시간을 함께 봅니다.`
    : "그때 샀다면 지금 어디쯤일까요? 같은 돈이 만든 격차와 하락, 회복의 시간을 함께 보는 과거 투자 시뮬레이터입니다.";
