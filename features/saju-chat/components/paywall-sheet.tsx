  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-end justify-center bg-black/70 backdrop-blur-sm sm:items-center">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[440px] px-4 pb-[calc(env(safe-area-inset-bottom)+16px)] pt-6 sm:pb-6">
        <div
          className="overflow-hidden rounded-[28px] border border-white/10 bg-[#12151C] shadow-[0_24px_80px_rgba(0,0,0,0.55)]"
          style={{ boxShadow: `0 24px 80px ${character.accent}28` }}
        >
          <div
