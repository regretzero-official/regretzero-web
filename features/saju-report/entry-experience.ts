...
export const SAJU_ENTRY_BY_SLUG: Record<SajuLandingSlug, SajuEntryContent> = {
  reunion: {
    ...
    lines: [
      ...
      "다만 지금은 조금 천천히 가도 돼. 급한 연락보다 타이밍이 중요해.",
      "오늘은 마음이 덜 바빠지게, 타이밍부터 분명히 짚어줄게.",
    ],
    concernChips: [
      "아직 미련이 남았어요",
      "연락이 올지 궁금해요",
    ...
    meetLabel: "점사 만나기",
    skipLabel: "건너뛰기",
    shrineTitle: "따뜻한 상담 공간으로 들어와요",
    shrineLine: "촛불이 포근해. 조용히, 그 사람 이야기부터 들어줄게.",
  ...
  heart: {
    ...
    shrineLine: "조명을 포근하게 낮췄어. 그 사람 이야기, 천천히 들어볼게.",
  ...
  breakup: {
    ...
    meetLabel: "점사 시작하기",
    skipLabel: "건너뛰기",
    shrineTitle: "차분한 상담실로 들어와요",
    shrineLine: "감정은 천천히. 지금은 선부터 차분히 그어줄게.",
    selfIdPrompt: "지금 가장 마음에 걸리는 지점을 골라보세요",
    inviteTitle: "우리 사이, 연을 알려주세요",
  ...
  strategy: {
    ...
    shrineLine: "조명을 부드럽게 낮추고, 첫 문장부터 같이 골라보자.",
