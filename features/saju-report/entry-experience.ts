...
export const SAJU_ENTRY_BY_SLUG: Record<SajuLandingSlug, SajuEntryContent> = {
  reunion: {
    ...
    shrineLine: "조명을 낮추고, 그 사람 쪽 흐름부터 같이 볼게요.",
  ...
  heart: {
    ...
    shrineLine: "포근한 불빛 아래, 그 사람 잔향부터 천천히 만져볼게.",
  ...
  breakup: {
    ...
    meetLabel: "점사 시작하기",
    skipLabel: "건너뛰기",
    shrineTitle: "차분한 방으로 들어와요",
    shrineLine: "감정은 나중에. 지금은 선부터 같이 그어줄게.",
  ...
  reason: {
    ...
    skipLabel: "건너뛰기",
    shrineTitle: "상담실 문을 열어요",
    shrineLine: "따뜻한 불빛 아래, 표면과 속부터 천천히 풀어볼게.",
