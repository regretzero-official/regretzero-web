...
export const SAJU_PRODUCTS: SajuProduct[] = [
  {
    ...
    description: "무당 백련이 기운으로 재회 가능성과 타이밍을 길게 읽어드려요.",
  ...
  },
  {
    ...
    description: "점쟁이 서나리가 여자의 시선으로 거리감과 남은 마음을 짚어드려요.",
  ...
  },
  {
    ...
    description: "깍쟁이 차유리가 팩트로, 후회 덜한 쪽을 정리해드려요.",
  ...
  },
  {
    ...
    description: "아이돌 한보라가 공감 먼저, 재접근 타이밍·해도 되는 말까지.",
