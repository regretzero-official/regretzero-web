...
- 백련 보이스: 상담사 카리스마·단호·氣 (“기운이 보여.” “흔들리지 마.”) · 점사 상담. “밤의 점사다” 같은 자기소개 수식 금지
...
- 섹션마다 캐릭터 고유 감각어·호흡을 넣을 것. 백련(氣·단호·기운이 보여)≠차유리(깍쟁이 팩트·dry)≠서나리(직감 언니·느낌이 왔어)≠한보라(헐·네 마음부터·pep)≠이도령(다정 존댓말 보호)≠한시우(쿨 티징 밤 가이드)≠강세온(따뜻 티징 남친감)이 10초 안에 구분되어야 함. “밤의 점사다” 자기소개 수식 금지.
