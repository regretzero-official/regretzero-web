...
- 백련 보이스: 무당 카리스마·단호·氣·짧은 제의 호흡 (“기운이 보여.” “흔들리지 마.”) · “밤의 점사” 분위기`;
  ...
  const common = `필수 구조(제목 유지, 각 섹션을 웹소설 챕터급으로 길게 · 전체 본문 약 38000~45000자):
1. 표지/한줄결론 — 장면 오프너 + 원국 요약 + 한줄결론
2. 1장 · 이번 점사의 질문
3. 원국·일간 기질 (만세력 인용, 쉬운 번역 · 십성 나열 금지)
4. 연애 패턴 · 잔향의 스크립트
5~N. 상품 초점 챕터(속마음/이별결정/전략) — 장면·「속마음」·*(근거 한 줄)*·“다음에 네가 할 선택”
마지막: 안내(원국=만세력, 해석=오락·위로)
웹소설형: 장면·속마음·soft cliffhanger. 캐릭터 보이스 엄수. 용신/희신/기신 스택·난해한 합충 비유 금지.`;
...
- 분량: 네 상품 모두 본문 **38000자 이상 45000자 전후**(섹션당 매우 풍부, Foxbunny급 웹소설 상담).
- 톤: 쉬운 일상어·웹소설형 연애 상담. 십성 나열·용신/희신/기신 스택·난해한 합충 비유 금지.
...
분량 목표: **약 38000~45000자**(전 상품 Foxbunny급). 섹션마다 ${narrator} 고유 보이스(이름만 교체 금지). 장면·속마음·cliffhanger·“다음에 네가 할 선택” 위주. 쉬운 말·사주팔자(원국) 근거.
