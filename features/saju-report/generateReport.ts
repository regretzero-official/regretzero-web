...
- 단정에 가까운 상담 호흡 OK. 단 확정 예언 금지—가능성/흐름상/~일 수 있다
...
점사/상담: 직접 호명·쉬운 풀이·원국 근거. 웹소설 챕터·문학 cliffhanger 금지. 캐릭터 보이스 엄수. 용신/희신/기신 스택·난해한 합충 비유 금지.`;
...
- 확정 예언 금지. “~일 가능성”, “흐름상”, “원국을 보면…”, “기운이…” 식으로. 단정에 가까운 상담 결론 OK.
...
제목/본문에 확정 예언처럼 쓰지 말 것(가능성/흐름상 OK). “프리미엄/MVP/프레임” 마케팅 톤 금지. 웹소설 챕터·문학 장면 pad 금지.
