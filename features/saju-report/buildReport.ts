  ...
  switch (characterId) {
    case "seo-nari":
      return {
        ...
        coverClose: `느낌이 왔어—다음 장(02)에서 질문·속마음·타이밍을 이어서 풀게. 지금은 여기까지.`,
        ...
        closingHook: (p, months) => `${months}—사랑은 안 죽었다. 근데 ${p} 마음에 네가 남아 있는지 묻기 전에, 남겨둘 만한 너로 먼저 서 있냐를 물어.`,
        closingBody: "네 진지함은 이미 충분해. 이번엔 그걸 무게가 아니라 안정으로 바꿔. 기회가 오면 들어가고, 안 와도 네가 혼자 무너지진 마.",
    ...
    case "baek-ryeon":
      return {
        ...
        questionsLead: "이번 점사—핵을 짧게 정리할게.",
        ...
        remainingAside: (p) => `백련이 말할게—지운 건 아니다. 근데 지금 당장 다시 만나자 할 마음은 아니다. ${p} 마음엔 남아 있는데, 손대긴 무서운 상태다. 이게 맞아.`,
        timelineAside: "지금은 들이댈 때가 아니야. 다시 연락하려면 최소 한두 달은 지나야 해. 조급하면 더 꼬이고, 네가 좀 괜찮아지면 기운이 다시 모인다.",
        contactAside: (p) => `${p}에게 추궁하면 상대만 부담스러워. 설득하지 마. 안정이 먼저야.`,
        strategyClose: "전략의 지표는 답장이 아니라, 네 기운이 회수됐는가다.",
        pitfallsLead: "함정을 끊는다. 확인하고 싶을 때가 가장 보내면 안 되는 때다.",
        closingHook: (p, months) => `${months}의 침묵은 삭제가 아니다. ${p} 자리를 묻기 전에—네 중심부터 세워. 남겨둘 만한 너로.`,
        closingBody: "진지함을 무게가 아니라 안정으로 바꿔. 타이밍이 와도, 네가 흔들리면 다시 멀어져. 괜찮은 상태인 사람 쪽으로 다시 모인다.",
        signOff: "이상, 백련. 괜찮은 상태인 사람 쪽으로 다시 모인다.",
    ...
    case "cha-yuri":
      return {
        ...
        coverClose: "팩트다. 다음 장(02)에서 질문·결정 축을 이어서 짚을게. 지금은 여기까지. 더 퍼주지 마.",
        ...
        closingBody: "진지한 거 알아. 근데 진지함을 무게로 쓰면 상대는 도망가. 안정으로 바꿔. 기회가 오면 들어가고, 안 와도 네가 초라해질 필요는 없어.",
        signOff: "이상, 차유리. 팩트 말했고—너는 더 아껴도 돼.",
        strategyNudge: "추궁·장문·자존 거래는 지금 하면 더 안 좋아져. 그만.",
    ...
    case "han-bora":
      return {
        ...
        coverClose: "다음 장(02)에서 질문·타이밍·멘트를 이어서 가자. 지금은 여기까지.",
        ...
        closingHook: (p, months) => `${months}—그리움은 남아 있어. 근데 ${p}에게 들이대기 전에—네가 무너지지 않는 하루를 먼저 만들자.`,
        closingBody: "응원할게. 진지함은 충분해—이번엔 무게 말고 안정으로. 기회가 오면 들어가고, 안 와도 네가 혼자는 아니야. 위험한 집착은 내가 말릴게.",
    ...
    case "lee-doryeong":
      return {
        ...
        coverClose: "다음 장(02)에서 끌린 이유·속마음·타이밍을 이어서 읽어드릴게요. 지금은 여기까지.",
        ...
        timelineAside: "지금은 들이댈 때가 아니에요. 다시 연락하려면 최소 한두 달은 지나야 해요. 조급함보다 네가 괜찮은 상태가 먼저예요.",
        contactAside: (p) => `${p}에게는 부드러운 한 줄이면 충분해요. 강요하면 상대만 부담스러워요.`,
        ...
        closingBody: "진지함은 이미 충분해요. 이번엔 무게가 아니라 안정으로. 기회가 오면 들어가시고, 안 와도 당신이 무너지진 않게.",
        signOff: "이상, 이도령. 기회가 오면 들어가고, 안 와도 당신이 무너지진 않게.",
        strategyNudge: "부드러운 한 줄이면 충분해요. 강요하면 상대만 부담스러워요.",
    ...
    case "kang-seon":
      return {
        ...
        coverClose: "여기서 멈춰. 다음 장(02)에서 속마음·타이밍을 이어서 정리하자. 지금은 여기까지.",
        ...
        closingBody: "선 넘지 말고, 자존은 올려. 진지함은 충분해—무게 말고 안정으로. 기회가 오면 들어가고, 안 와도 네가 무너지진 마.",
        ...
        keepLeaveClose: "결정은 감정 점수 말고, 네가 먼저 괜찮은 상태인지로.",
        selfRoutineClose: "흔들림 줄이면 침묵도 작아져. 루틴이 매력이야.",
        dontNowLead: "지금은 설득 말고 생활. 네가 좀 괜찮은 상태부터.",
      };
    case "han-siwoo":
    default:
      return {
        ...
        coverClose: "다음 장(02)에서 타이밍·멘트를 이어서 짚을게. 지금은 여기까지. 한 박자 쉬어.",
        ...
        timelineAside: "지금은 들이댈 때가 아니야. 다시 연락하려면 최소 한두 달은 지나야 해. 조급하면 더 꼬여.",
        contactAside: (p) => `${p}에게 추궁하면 상대만 부담스러워. 확인하고 싶을 때가 가장 보내면 안 되는 때다.`,
        strategyClose: "지표는 답장이 아니라, 네가 좀 괜찮은지다.",
        pitfallsLead: "함정—확인하고 싶을 때가 가장 보내면 안 되는 때다.",
        closingHook: (p, months) => `${months}—사랑은 안 죽었다. 근데 예전의 방식까지 살아 있으면, ${p}와 다시 만나도 또 지친다.`,
        closingBody: "조급하면 더 꼬이고, 괜찮은 상태인 사람 쪽으로 다시 모인다. 기회가 오면 들어가고, 안 와도 네가 무너지진 않게.",
        signOff: "이상, 한시우. 조급하면 더 꼬이고, 괜찮은 상태인 사람 쪽으로 다시 모인다.",
...
3. **감정이 커질 때**: 상대의 페이스가 안 맞으면, 확인·해석·장문이 늘어난다.
...
- **도움**: 표현을 부드럽게, 페이스를 조절
- **피해야 할 것**: 과한 확인·추궁·자존 싸움

${voice.patternClose(p)}
${voice.strategyNudge}

패턴을 바꿀 때 기억할 한 줄: **설득보다 안정**. 같은 스크립트의 3단계(감정이 커질 때)를 반복하면 이야기는 같은 결말로 복제돼. 헤어진 지 ${monthsLabel(form)} · “${breakupLine(form)}” 메모를 기준으로, 지금은 감정을 더 쓰는 구간이 아니라 기력을 회수하는 구간으로 읽는 편이 맞다.
...
정리: **남아 있다 ≠ 지금 받아줄 준비가 됐다.** 지운 건 아냐. 근데 지금 당장 다시 만나자 할 마음은 아니야.

「그럼… 기다리면 열려?」
기다림만으로는 안 열려. **네가 안전해 보이는 시간**이 쌓일 때 잠금이 느슨해진다. 그 시간은 검색이 아니라 루틴으로 채워.

다음에 네가 할 선택: 지금 당장 다시 만나자고 밀지 말고, 밀어도 안 무서울 너로 서 있기.`,
  };
}
...
고민(${concernLine(form)})에 대해: **타이밍은 1개월 이후의 가벼운 안부가 더 안전**한 편이다.
...
6. **‘${breakupLine(form)}’ 사실 부정**: 안 아팠던 척하면 같은 ‘감정 커짐’ 패턴으로 돌아간다.
...
다음에 네가 할 선택: 오늘 밤, 확인 대신 일상. 그게 다음 선택의 첫 문장이야.
...
「답장이 없으면… 나는 끝인 건가.」
그 속마음이 올라와도, 전송은 하지 마. 답장이 없어도 네가 무너지지 않는 모습이, 아이러니하게 ${p}에게 덜 무섭게 보여. 언니가 본 잔향은 그래—안전감이 그리움을 부르지, 추궁이 부르지 않아.

헤어진 지 ${monthsLabel(form)} · “${breakupLine(form)}” 메모를 기준으로 하면, 지금 과한 온기는 부담이야.
...
*(근거 한 줄)* 온도는 낮을수록 말하기가 쉬워져. 느낌이 왔지?
...
function oneLinerFor(productId: SajuProductId, form: SajuBirthForm): string {
  ...
  switch (productId) {
    case "reunion-luck":
      return `**지금은 연락할 때가 아니야.** 인연이 완전히 끊긴 건 아니야. **지금은 다가가지 마. 한두 달에서 세 달쯤 지나야 다시 말할 타이밍이야.** 지금 연락·고백·장문 보내면 더 안 좋아져.`;
    case "partner-heart":
...
function bulletsFor(productId: SajuProductId, form: SajuBirthForm): string[] {
  ...
  switch (productId) {
    ...
    case "breakup-decision":
      return [
        "소모가 사랑보다 커졌다면, 결정은 ‘감정’이 아니라 네가 괜찮은 상태인지로.",
        "남겨둘 조건과 놓을 조건을 문장으로 적어라.",
        "자존 회복 없는 재시도는 같은 이별을 복제한다.",
      ];
    case "reunion-strategy":
      return [
        "1단계: 네 기운 회수. 2단계: 가벼운 안부 접촉. 3단계: 과거 재판 금지.",
